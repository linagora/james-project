...
public class CassandraRoutesModule extends AbstractModule {
    ...
    private static final SchemaTransition FROM_V12_TO_V13 = SchemaTransition.to(new SchemaVersion(12));
    ...
    protected void configure() {
        ...
        allMigrationClazzBinder.addBinding(FROM_V12_TO_V13).to(SieveQuotaMigration.class);
