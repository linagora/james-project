...
public class ConfigurationsPerformerTest {
    ...
    private static class MyModule extends ConfigurablesModule {
    ...
    public void initModulesShouldBePerformedOneTimeWhenConfigurableModuleContainsMultipleDependencies() throws Exception {
        Injector injector = Guice.createInjector(new ConfigurablesModule(),
                new ABConfigurationPerformerModule());
    ...
    private static class ABConfigurationPerformer implements ConfigurationPerformer {
        ...
        @Inject
        private ABConfigurationPerformer(A a, B b) {
            this.a = a;
            this.b = b;
    ...
    private static class ABConfigurationPerformerModule extends ConfigurablesModule {
        ...
        protected void configure() {
            ...
            Multibinder.newSetBinder(binder(), ConfigurationPerformer.class).addBinding().to(ABConfigurationPerformer.class);
        }
    }
}
