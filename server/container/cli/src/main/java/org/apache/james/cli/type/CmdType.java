...
public enum CmdType {
    ...
    LISTMAILSINREPOSITORY("ListMailsInRepository", "repositoryPath"),
    GETMAILINREPOSITORY("GetMailInRepository", "repositoryPath", "emailKey"),
    DELETEMAILINREPOSITORY("DeleteMailInRepository", "repositoryPath", "emailKey"),
    DELETEMAILSINREPOSITORY("DeleteMailsInRepository", "repositoryPath"),
    REPROCESSALLMAILS("ReprocessAllMails", "repositoryPath"),
    REPROCESSMAIL("ReprocessMail", "repositoryPath", "emailKey"),
