...
public class DSNBounce extends AbstractRedirect {
    ...
    private static final RFC822DateFormat RFC8822_DATE_FORMAT = new RFC822DateFormat();
    ...
    public void service(Mail originalMail) throws MessagingException {
        ...
        try {
            ...
            if (newMail.getMessage().getHeader(RFC2822Headers.DATE) == null) {
                newMail.getMessage().setHeader(RFC2822Headers.DATE, RFC8822_DATE_FORMAT.format(new Date()));
            }
    ...
    private void appendRecipient(StringBuffer buffer, MailAddress mailAddress, String deliveryError, Date lastUpdated) {
        ...
        buffer.append("Last-Attempt-Date: " + RFC8822_DATE_FORMAT.format(lastUpdated))
            .append(LINE_BREAK);
    }
