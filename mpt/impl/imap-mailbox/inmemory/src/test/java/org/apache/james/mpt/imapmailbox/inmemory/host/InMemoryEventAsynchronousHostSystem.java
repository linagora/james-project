...
public class InMemoryEventAsynchronousHostSystem extends JamesImapHostSystem {
    ...
    private void initFields() throws MailboxException {
        ...
        final ImapProcessor defaultImapProcessorFactory = DefaultImapProcessorFactory.createDefaultProcessor(mailboxManager, new StoreSubscriptionManager(factory), quotaManager, quotaRootResolver, new DefaultTimeMetricFactory(), new DefaultTimeLogger());
