...
public class InMemoryHostSystem extends JamesImapHostSystem {
    ...
    private void initFields() throws MailboxException {
        ...
        final ImapProcessor defaultImapProcessorFactory = DefaultImapProcessorFactory.createDefaultProcessor(mailboxManager, new StoreSubscriptionManager(mailboxManager.getMapperFactory()), quotaManager, quotaRootResolver, new DefaultTimeMetricFactory(), new DefaultTimeLogger());
