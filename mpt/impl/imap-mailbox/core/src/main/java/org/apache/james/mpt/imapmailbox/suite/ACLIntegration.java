...
public abstract class ACLIntegration implements ImapTestConstants {
    ...
    public void rightRShouldBeSufficientToPerformStatusSelectCloseExamineUS() throws Exception {
        scriptedTestProtocol
            .withGrantRights(OTHER_USER_MAILBOX, USER, MailboxShares.Rfc4314Rights.fromSerializedRfc4314Rights("r"))
    ...
    public void rightRShouldBeNeededToPerformStatusSelectCloseExamineUS() throws Exception {
        scriptedTestProtocol
            .withGrantRights(OTHER_USER_MAILBOX, USER, MailboxShares.Rfc4314Rights.fromSerializedRfc4314Rights("lswipkxtecda"))
    ...
    public void rightLShouldBeSufficientToPerformListUS() throws Exception {
        scriptedTestProtocol
            .withGrantRights(OTHER_USER_MAILBOX, USER, MailboxShares.Rfc4314Rights.fromSerializedRfc4314Rights("l"))
    ...
    public void rightLShouldBeNeededToPerformListLsubSubscribeUS() throws Exception {
        scriptedTestProtocol
            .withGrantRights(OTHER_USER_MAILBOX, USER, MailboxShares.Rfc4314Rights.fromSerializedRfc4314Rights("rswipkxtecda"))
    ...
    public void rightAShouldBeSufficientToManageACLUS() throws Exception {
        scriptedTestProtocol
            .withGrantRights(OTHER_USER_MAILBOX, USER, MailboxShares.Rfc4314Rights.fromSerializedRfc4314Rights("a"))
    ...
    public void rightAShouldBeNeededToManageACLUS() throws Exception {
        scriptedTestProtocol
            .withGrantRights(OTHER_USER_MAILBOX, USER, MailboxShares.Rfc4314Rights.fromSerializedRfc4314Rights("rswipkxtecdl"))
    ...
    public void rightXOnOriginShouldBeSufficientToRenameAMailboxUS() throws Exception {
        scriptedTestProtocol
            ...
            .withGrantRights(MailboxPath.forUser( OTHER_USER_NAME, "test"), USER, MailboxShares.Rfc4314Rights.fromSerializedRfc4314Rights("x"))
    ...
    public void rightXOnOriginShouldBeNeededToRenameAMailboxUS() throws Exception {
        scriptedTestProtocol
            .withMailbox(MailboxPath.forUser("Boby","test"))
            .withGrantRights(MailboxPath.forUser( OTHER_USER_NAME, "test"), USER, MailboxShares.Rfc4314Rights.fromSerializedRfc4314Rights("rswipktela"))
    ...
    public void rightKOnDestinationShouldBeSufficientToRenameAMailboxUS() throws Exception {
        ...
        scriptedTestProtocol
            ...
            .withGrantRights(newMailbox, USER, MailboxShares.Rfc4314Rights.fromSerializedRfc4314Rights("x"))
            .withGrantRights(OTHER_USER_MAILBOX, USER, MailboxShares.Rfc4314Rights.fromSerializedRfc4314Rights("k"))
    ...
    public void rightKOnDestinationShouldBeNeededToRenameAMailboxUS() throws Exception {
        ...
        scriptedTestProtocol
            .withMailbox(newMailbox)
            .withGrantRights(newMailbox, USER, MailboxShares.Rfc4314Rights.fromSerializedRfc4314Rights("x"))
            .withGrantRights(OTHER_USER_MAILBOX, USER, MailboxShares.Rfc4314Rights.fromSerializedRfc4314Rights("rswipxtela"))
    ...
    public void rightREShouldBeSufficientToPerformExpungeUS() throws Exception {
        scriptedTestProtocol
            .withGrantRights(OTHER_USER_MAILBOX, USER, MailboxShares.Rfc4314Rights.fromSerializedRfc4314Rights("re"))
    ...
    public void rightEShouldBeNeededToPerformExpungeUS() throws Exception {
        scriptedTestProtocol
            .withGrantRights(OTHER_USER_MAILBOX, USER, MailboxShares.Rfc4314Rights.fromSerializedRfc4314Rights("rswipxtclak"))
    ...
    public void rightIShouldBeSufficientToPerformAppendUS() throws Exception {
        scriptedTestProtocol
            .withGrantRights(OTHER_USER_MAILBOX, USER, MailboxShares.Rfc4314Rights.fromSerializedRfc4314Rights("ri"))
    ...
    public void rightIShouldBeNeededToPerformAppendUS() throws Exception {
        scriptedTestProtocol
            .withGrantRights(OTHER_USER_MAILBOX, USER, MailboxShares.Rfc4314Rights.fromSerializedRfc4314Rights("rswepxtcdlak"))
    ...
    public void rightISShouldBeSufficientToPerformAppendOfSeenMessageUS() throws Exception {
        scriptedTestProtocol
            .withGrantRights(OTHER_USER_MAILBOX, USER, MailboxShares.Rfc4314Rights.fromSerializedRfc4314Rights("ris"))
    ...
    public void rightITShouldBeSufficientToPerformAppendOfDeletedMessageUS() throws Exception {
        scriptedTestProtocol
            .withGrantRights(OTHER_USER_MAILBOX, USER, MailboxShares.Rfc4314Rights.fromSerializedRfc4314Rights("rit"))
    ...
    public void rightIWShouldBeSufficientToPerformAppendOfDeletedMessageUS() throws Exception {
        scriptedTestProtocol
            .withGrantRights(OTHER_USER_MAILBOX, USER, MailboxShares.Rfc4314Rights.fromSerializedRfc4314Rights("riw"))
    ...
    public void rightRSShouldBeSufficientToPerformStoreAndFetchOnSeenMessageUS() throws Exception {
        scriptedTestProtocol
            .withGrantRights(OTHER_USER_MAILBOX, USER, MailboxShares.Rfc4314Rights.fromSerializedRfc4314Rights("rs"))
    ...
    public void rightSShouldBeNeededToPerformStoreAndFetchOnSeenMessageUS() throws Exception {
        scriptedTestProtocol
            .withGrantRights(OTHER_USER_MAILBOX, USER, MailboxShares.Rfc4314Rights.fromSerializedRfc4314Rights("rwipxtcdlake"))
            .withFilledMailbox(OTHER_USER_MAILBOX)
    ...
    public void rightRWShouldBeSufficientToPerformStoreOnFlaggedMessageUS() throws Exception {
        scriptedTestProtocol
            .withGrantRights(OTHER_USER_MAILBOX, USER, MailboxShares.Rfc4314Rights.fromSerializedRfc4314Rights("rw"))
            .withFilledMailbox(OTHER_USER_MAILBOX)
    ...
    public void rightWShouldBeNeededToPerformStoreOnFlaggedMessageUS() throws Exception {
        scriptedTestProtocol
            .withGrantRights(OTHER_USER_MAILBOX, USER, MailboxShares.Rfc4314Rights.fromSerializedRfc4314Rights("rsipxtcdlake"))
            .withFilledMailbox(OTHER_USER_MAILBOX)
    ...
    public void rightRTShouldBeSufficientToPerformStoreOnDeletedMessageUS() throws Exception {
        scriptedTestProtocol
            .withGrantRights(OTHER_USER_MAILBOX, USER, MailboxShares.Rfc4314Rights.fromSerializedRfc4314Rights("rt"))
            .withFilledMailbox(OTHER_USER_MAILBOX)
    ...
    public void rightTShouldBeNeededToPerformStoreOnFlaggedMessageUS() throws Exception {
        scriptedTestProtocol
            .withGrantRights(OTHER_USER_MAILBOX, USER, MailboxShares.Rfc4314Rights.fromSerializedRfc4314Rights("rwipxslake"))
            .withFilledMailbox(OTHER_USER_MAILBOX)
    ...
    public void rightIShouldBeSufficientToPerformCopyUS() throws Exception {
        scriptedTestProtocol
            .withGrantRights(OTHER_USER_MAILBOX, USER, MailboxShares.Rfc4314Rights.fromSerializedRfc4314Rights("i"))
    ...
    public void rightIShouldBeNeededToPerformCopyUS() throws Exception {
        scriptedTestProtocol
            .withGrantRights(OTHER_USER_MAILBOX, USER, MailboxShares.Rfc4314Rights.fromSerializedRfc4314Rights("rswpxtcdlake"))
            .withFilledMailbox(MY_INBOX)
    ...
    public void rightSShouldBeNeededToPerformCopyOfSeenMessageUS() throws Exception {
        scriptedTestProtocol
            .withGrantRights(OTHER_USER_MAILBOX, USER, MailboxShares.Rfc4314Rights.fromSerializedRfc4314Rights("riwpxtcdlake"))
            .withFilledMailbox(MY_INBOX)
    ...
    public void rightWShouldBeNeededToPerformCopyOfFlaggedMessageUS() throws Exception {
        scriptedTestProtocol
            .withGrantRights(OTHER_USER_MAILBOX, USER, MailboxShares.Rfc4314Rights.fromSerializedRfc4314Rights("rispxtcdlake"))
            .withFilledMailbox(MY_INBOX)
    ...
    public void rightTShouldBeNeededToPerformCopyOfDeletedMessageUS() throws Exception {
        scriptedTestProtocol
            .withGrantRights(OTHER_USER_MAILBOX, USER, MailboxShares.Rfc4314Rights.fromSerializedRfc4314Rights("rispxwlake"))
            .withFilledMailbox(MY_INBOX)
