...
public class ElasticSearchHostSystem extends JamesImapHostSystem {
    ...
    private void initFields() {
        ...
        InMemoryAttachmentMapper attachmentMapper = new InMemoryAttachmentMapper();
        mailboxManager = new StoreMailboxManager(factory, authenticator, authorizator, aclResolver, groupMembershipResolver, messageParser,
            messageIdFactory, MailboxConstants.DEFAULT_LIMIT_ANNOTATIONS_ON_MAILBOX, MailboxConstants.DEFAULT_LIMIT_ANNOTATION_SIZE, attachmentMapper);
