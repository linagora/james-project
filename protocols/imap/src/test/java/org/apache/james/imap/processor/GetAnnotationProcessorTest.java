...
public class GetAnnotationProcessorTest {
    ...
    private final MailboxAnnotation SHARED_ANNOTATION = MailboxAnnotation.newInstance(SHARED_KEY, "The shared size");
    private final MailboxAnnotation PRIVATE_ANNOTATION = MailboxAnnotation.newInstance(PRIVATE_KEY, "The short size");
    private final MailboxAnnotation PRIVATE_CHILD_ANNOTATION = MailboxAnnotation.newInstance(PRIVATE_CHILD_KEY, "The middle size");
    private final MailboxAnnotation PRIVATE_GRANDCHILD_ANNOTATION = MailboxAnnotation.newInstance(PRIVATE_GRANDCHILD_KEY, "The longest value size");
    ...
    public void processShouldGetAnnotationsAndReturnCompleteResponseWithTheLongestEntryInfoWhenLimitMaxsize() throws Exception {
        ...
        processor.process(annotationRequestBuilder.maxsize(10).build(), mockResponder, mockImapSession);
    ...
    public void processShouldGetAnnotationsAndReturnCompleteResponseDoesNotTruncateDataByMaxsize() throws Exception {
        ...
        processor.process(annotationRequestBuilder.maxsize(100).build(), mockResponder, mockImapSession);
    ...
    public void processShouldGetAnnotationsAndReturnCompleteResponseWithTruncateDataByMaxsize() throws Exception {
        ...
        processor.process(annotationRequestBuilder.maxsize(15).build(), mockResponder, mockImapSession);
    ...
    public void processShouldGetAnnotationsByOneDepthAndReturnCompleteResponseWithTruncateDataByMaxsize() throws Exception {
        ...
        processor.process(annotationRequestBuilder.maxsize(14).depth(Depth.ONE).keys(KEYS).build(), mockResponder, mockImapSession);
    ...
    public void processShouldGetAnnotationsByInfinityDepthAndReturnCompleteResponseWithTruncateDataByMaxsize() throws Exception {
        ...
        processor.process(annotationRequestBuilder.maxsize(14).depth(Depth.INFINITY).keys(KEYS).build(), mockResponder, mockImapSession);
