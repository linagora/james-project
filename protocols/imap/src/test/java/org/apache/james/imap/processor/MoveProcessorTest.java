...
public class MoveProcessorTest {
    ...
    public void setUp() {
        ...
        testee = new MoveProcessor(mockNextProcessor, mockMailboxManager, mockStatusResponseFactory, new NoopTimeMetricFactory(), new NoopTimeLogger());
    ...
    public void getImplementedCapabilitiesShouldNotContainMoveWhenUnSupportedByMailboxManager() {
        ...
        assertThat(new MoveProcessor(mockNextProcessor, mockMailboxManager, mockStatusResponseFactory, new NoopTimeMetricFactory(), new NoopTimeLogger())
