...
public class ListRightsProcessorTest {
    ...
    public void testListRights() throws MailboxException {
        ...
        expectations.allowing(mailboxManagerStub).getRightManager().listRigths(expectations.with(path), expectations.with(Expectations.equal(user1Key)), expectations.with(Expectations.same(mailboxSessionStub)));
