...
public class DeleteACLProcessorTest {
    ...
    public void testDelete() throws MailboxException {
        ...
        expectations.allowing(mailboxManagerStub).getRightManager().applyRightsCommand(expectations.with(path), expectations.with(MailboxACL.command().key(user1Key).noRights().asReplacement()), expectations.with(mailboxSessionStub));
