...
public class ListingEncodingUtilsTest  {
    ...
    public void testShouldAddHasChildrenToAttributes() throws Exception {
        ...
        ListResponse input = new ListResponse(false, false, false, false, true, false, nameParameter, new PathDelimiter('.'));
    ...
    public void testShouldAddHasNoChildrenToAttributes() throws Exception {
        ...
        ListResponse input = new ListResponse(false, false, false, false, false, true, nameParameter, new PathDelimiter('.'));
