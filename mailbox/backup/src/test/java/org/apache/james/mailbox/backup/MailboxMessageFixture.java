...
public interface MailboxMessageFixture {
    ...
    Mailbox MAILBOX_1 = new SimpleMailbox(MAILBOX_PATH_USER1_MAILBOX1, 42, MAILBOX_ID_1);
    Mailbox MAILBOX_1_OTHER_USER = new SimpleMailbox(MAILBOX_PATH_OTHER_USER_MAILBOX1, 42, MAILBOX_ID_11);
    Mailbox MAILBOX_1_SUB_1 = new SimpleMailbox(MAILBOX_PATH_USER1_MAILBOX1_SUB_1, 420, TestId.of(11L));
    Mailbox MAILBOX_2 = new SimpleMailbox(MAILBOX_PATH_USER1_MAILBOX2, 43, MAILBOX_ID_2);
