...
public class MailboxMessageToElasticSearchJsonTest {
    ...
    public void convertToJsonShouldThrowWhenNoUser() throws Exception {
        ...
        MailboxMessage spamMail = new SimpleMailboxMessage(
                new TestMessageId.Factory().generate(),
                date,
                SIZE,
                BODY_START_OCTET,
    ...
    public void htmlEmailShouldBeWellConvertedToJson() throws IOException {
        MessageToElasticSearchJson messageToElasticSearchJson = new MessageToElasticSearchJson(
            new DefaultTextExtractor(),
            ZoneId.of("Europe/Paris"));
        MailboxMessage htmlMail = new SimpleMailboxMessage(
                new TestMessageId.Factory().generate(),
                date,
                SIZE,
                BODY_START_OCTET,
    ...
    public void pgpSignedEmailShouldBeWellConvertedToJson() throws IOException {
        MessageToElasticSearchJson messageToElasticSearchJson = new MessageToElasticSearchJson(
            new DefaultTextExtractor(),
            ZoneId.of("Europe/Paris"));
        MailboxMessage pgpSignedMail = new SimpleMailboxMessage(
                new TestMessageId.Factory().generate(),
                date,
                SIZE,
                BODY_START_OCTET,
    ...
    public void simpleEmailShouldBeWellConvertedToJson() throws IOException {
        MessageToElasticSearchJson messageToElasticSearchJson = new MessageToElasticSearchJson(
            new DefaultTextExtractor(),
            ZoneId.of("Europe/Paris"));
        MailboxMessage mail = new SimpleMailboxMessage(
                new TestMessageId.Factory().generate(),
                date,
                SIZE,
                BODY_START_OCTET,
    ...
    public void recursiveEmailShouldBeWellConvertedToJson() throws IOException {
        MessageToElasticSearchJson messageToElasticSearchJson = new MessageToElasticSearchJson(
            new DefaultTextExtractor(),
            ZoneId.of("Europe/Paris"));
        MailboxMessage recursiveMail = new SimpleMailboxMessage(
                new TestMessageId.Factory().generate(),
                date,
                SIZE,
                BODY_START_OCTET,
    ...
    public void emailWithNoInternalDateShouldUseNowDate() throws IOException {
        MessageToElasticSearchJson messageToElasticSearchJson = new MessageToElasticSearchJson(
            new DefaultTextExtractor(),
            ZoneId.of("Europe/Paris"));
        MailboxMessage mailWithNoInternalDate = new SimpleMailboxMessage(
                new TestMessageId.Factory().generate(),
                null,
                SIZE,
                BODY_START_OCTET,
    ...
    public void emailWithNoMailboxIdShouldThrow() throws IOException {
        ...
        try {
            mailWithNoMailboxId = new SimpleMailboxMessage(
                    new TestMessageId.Factory().generate(),
                    date,
                    SIZE,
                    BODY_START_OCTET,
