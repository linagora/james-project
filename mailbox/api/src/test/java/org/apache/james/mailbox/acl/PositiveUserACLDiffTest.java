...
public class PositiveUserACLDiffTest {
    ...
    public void addedEntriesShouldReturnEmptyWhenSameACL() {
        PositiveUserACLDiff positiveUserAclDiff = PositiveUserACLDiff.from(
            MailboxACL.EMPTY,
            MailboxACL.EMPTY);
    ...
    public void addedEntriesShouldReturnEmptyWhenSameNonEmptyACL() throws UnsupportedRightException {
        ...
        PositiveUserACLDiff positiveUserAclDiff = PositiveUserACLDiff.from(mailboxACL, mailboxACL);
