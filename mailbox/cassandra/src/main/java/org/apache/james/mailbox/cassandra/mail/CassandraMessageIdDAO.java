...
public class CassandraMessageIdDAO {
    ...
    public List<ComposedMessageIdWithMetaData> retrieveMessages(CassandraId mailboxId, MessageRange set) {
        switch (set.getType()) {
        case ALL:
    ...
    private CompletableFuture<List<ComposedMessageIdWithMetaData>> toMessageIds(CompletableFuture<ResultSet> completableFuture) {
