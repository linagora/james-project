...
public class MailboxMessageAssertTest {
    ...
    public static final TestMessageId.Factory messageIdFactory = new TestMessageId.Factory();
    ...
    public void messageAssertShouldSucceedWithTwoEqualsMessages() throws IOException {
        ...
        Date date = new Date();
        SimpleMailboxMessage message1 = new SimpleMailboxMessage(messageIdFactory.generate(), date, headerString.length() + bodyString.length(),
        ...
        message1.setUid(UID);
        SimpleMailboxMessage message2 = new SimpleMailboxMessage(messageIdFactory.generate(), date, headerString.length() + bodyString.length(),
            headerString.length(), new SharedByteArrayInputStream((headerString + bodyString).getBytes()), new Flags(), new PropertyBuilder(), MAILBOX_ID);
        message2.setUid(UID);
