...
public class EventDataTransferObject {
    ...
    public static class Builder {
        ...
        private Optional<QuotaCount> quotaCount;
        private Optional<QuotaSize> quotaSize;
        ...
        public Builder quotaCount(Optional<QuotaCount> quotaCount) {
            this.quotaCount = quotaCount;
            return this;
        }

        public Builder quotaSize(Optional<QuotaSize> quotaSize) {
            this.quotaSize = quotaSize;
            return this;
        }

        public EventDataTransferObject build() {
            return new EventDataTransferObject(type, mailbox, session, uids, metaData, updatedFlags, from, quotaRoot, quotaCount, quotaSize);
        }
    ...
    public EventDataTransferObject(EventType type,
                                   ...
                                   Optional<QuotaCount> quotaCount, 
                                   Optional<QuotaSize> quotaSize) {
        this.type = type;
        this.mailbox = mailbox;
        this.session = session;
        this.uids = uids;
    ...
    @JsonIgnore
    public Optional<QuotaCount> getQuotaCount() {
        return quotaCount;
    }

    @JsonIgnore
    public Optional<QuotaSize> getQuotaSize() {
        return quotaSize;
    }
}